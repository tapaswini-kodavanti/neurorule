...
from pyleafai.toolkit.policy.reproduction.primitives.number_jump_mutator \
    import NumberJumpMutator
from pyleafai.toolkit.policy.reproduction.primitives.number_midpoint_crossover \
    import NumberMidpointCrossover
from pyleafai.toolkit.policy.reproduction.primitives.number_overshoot_crossover \
    import NumberOvershootCrossover


class NumberOperatorSuite(OperatorSuite):
    '''
    ...
    def default_registration(self, random):
        ...
        self.register(NumberJumpMutator(random, evolved_number_spec))
        ...
        #  where N is the width of the range of solutions.
        self.register(NumberMidpointCrossover(evolved_number_spec))
        self.register(NumberOvershootCrossover(random, evolved_number_spec))
