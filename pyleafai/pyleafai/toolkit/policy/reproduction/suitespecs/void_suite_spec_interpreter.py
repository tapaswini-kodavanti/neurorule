...
from pyleafai.toolkit.policy.reproduction.structures.void_operator_suite \
    import VoidOperatorSuite


class VoidSuiteSpecInterpreter(SuiteSpecInterpreter):
    """
    SuiteSpecInterpreter implementation that knows how to
    create a VoidOperatorSuite from a given EvolvedParameterSpec.
    """
    ...
    def interpret_spec(self, spec, obj):
        ...
        :return: A VoidOperatorSuite given the spec.
        """

        # Note: _ is Pythonic for unused variable
        _ = obj
        suite = VoidOperatorSuite(spec.get_name())
        return suite
