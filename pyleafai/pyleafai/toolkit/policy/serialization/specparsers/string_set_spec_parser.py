...
class StringSetSpecParser(SpecParser):
    """
    Parser implementation that grabs information about EvolvedParameterSetSpec,
    where choices are picked from a uniform distribution among a set of values.
    """
